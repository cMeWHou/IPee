...
/**
 * @brief Callback function for processing keys and values of collection records with arguments.
 * 
 * @param key Record key.
 * @param value Record value.
...
/**
 * @brief Callback function for processing keys of collection records with arguments.
 * 
 * @param value Record value.
 * @param args Arguments for callback function.
 */
...
/**
 * @brief Callback function for processing values of collection records with arguments.
 * 
 * @param value Record value.
 * @param args Arguments for callback function.
 */
 ...
 * @return Result of comparsion.
 */
typedef int (*dictionary_iteration_callback_sort)(const p_record record1, const p_record record2);
 ...
 * @return Result of comparsion.
 */
typedef int (*dictionary_iteration_callback_sort_with_args)(const p_record record1, const p_record record2, void *args);
 ...
 * 
 * @details
 * Get the previous record before the current one from specified dictionary by key of current record.
 * Return the value of previous record, if it exists else NULL.
 *
 * @param dict Dictionary.
 * @param key Record key.
 ...
 * @details
 * Get the previous record before the current one from specified dictionary by key of current record.
 * Return the key of previous record, if it exists else NULL.
 *
 * @param dict Dictionary.
 * @param key Record key.
 ...
 */
extern p_dictionary map_dictionary(const p_dictionary dict, dictionary_iteration_callback_map callback);
 ...
 */
extern p_dictionary filter_dictionary(const p_dictionary dict, dictionary_iteration_callback_filter callback);
 ...
 */
extern void *reduce_dictionary(const p_dictionary dict, dictionary_iteration_callback_reduce callback, void *acc);
 ...
 * @param callback Callback function.
 */
extern p_dictionary sort_dictionary(const p_dictionary dict, dictionary_iteration_callback_sort callback);
