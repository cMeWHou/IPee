...
typedef enum service_type_e {
    SERVICE_TYPE_SINGLETON, // One instance of service in the application.
    SERVICE_TYPE_TRANSIENT, // New instance of service on each new request.
    SERVICE_TYPE_GLBLVALUE, // Global value.
 ...
 * @param release_callback Release callback function.
 */
extern void add_transient_to_container(
    p_container container, char *key,
    container_callback_function initial_callback,
    container_callback_function release_callback);
 ...
 * @details
 * Add new service to application container.
 * If service with specified key si already exists it will be replaced.
 *
 * @param name             Container name.
 * @param type             Lifetime type.
 * @param key              Service identifier.
 ...
 * @param container Container reference.
 * @param key       Service identifier.
 * @param new_args  Arguments.
 *
 * @return Service instance.
 */
extern void *get_service_from_container_with_args(
    p_container container, char *key, void *new_args);
